...
{
    /*
     * Derives from TrackingConfiguration and keeps type information making method calls simpler.
     * It does not provide any new functionality. All calls are forwarded to the base class.
     */
    ...
    {
        internal TrackingConfiguration(Tracker tracker) : base(tracker)
        {
        }
